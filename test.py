...
# %%
chart = plot.createKlineOfData('002594.SZ', '20200101', '20201231')
chart.render_notebook()

# %%
chart = plot.createKlineOfData('002594.SZ')
chart.render("test3.html")

# %%
leftDf = stockData[['trade_date', 'open']]
rightDf = stockData[['trade_date', 'vol']]
rightDf = rightDf[20:80]

# %%
line = plot.createDiffLines(leftDf, rightDf, 'A', 'B')
line.render_notebook()

# %%
stockData1 = DBLib.getDataFromDB('002271.SZ', 'daily11')
stockData1 = stockData1.iloc[2900:3001]
leftDf = stockData1[['trade_date', 'open', 'close', 'low', 'high']]
stockData2 = DBLib.getDataFromDB('600276.SH', 'daily16')
stockData2 = stockData2.iloc[2900:3001]
rightDf = stockData2[['trade_date', 'open', 'close', 'low', 'high']]
