##
# 从雪球爬取美股分红表。 
# 爬取链接为："https://stock.xueqiu.com/v5/stock/f10/us/bonus.json?symbol=%s&size=10000&page=1&extend=true" % code
##
...
def crawlDivident(code):
    ...
    FileLogger.info("get divident of code: %s in size: %d" % (code, len(content)))
