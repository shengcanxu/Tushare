...
def getCashflowOnDate(tsCode, tushare, dbEngine):
    try:
        stockCashflow = tushare.cashflow(ts_code=tsCode, start_date='19901210', end_date='20210228')
...
if __name__ == "__main__":
    ...
    for tsCode in stockList:
        code = tsCode[0]
        getCashflowOnDate(code, pro, engine)
